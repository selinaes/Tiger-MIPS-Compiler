        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction3(strm, yyNO_MATCH)
                      else yyQ72(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction3(strm, yyNO_MATCH)
                  else yyQ72(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction2(strm, yyNO_MATCH)
                      else yyQ72(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction2(strm, yyNO_MATCH)
                  else yyQ72(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ72(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction4(strm, yyNO_MATCH)
                      else yyQ72(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction4(strm, yyNO_MATCH)
                  else yyQ72(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ72(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #":"
              ...
              then if inp = #"\^N"
                  ...
                  then yyAction1(strm, yyNO_MATCH)
                  else yyQ72(strm', yyMATCH(strm, yyAction1, yyNO_MATCH))
            else if inp = #"`"
              then yyAction1(strm, yyNO_MATCH)
            else if inp < #"`"
              then if inp = #"["
       ...
       of NONE => yyAction42(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ111(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ72(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
              else yyAction42(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction42(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ115(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ72(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
              else yyAction42(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ51 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction25(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ119(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
...
fun yyQ121 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ121(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ47 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction28(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ122(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
...
fun yyQ14 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction53(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"5"
              then yyQ24(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
            else if inp < #"5"
              then if inp <= #"/"
                  then yyAction53(strm, yyNO_MATCH)
                  else yyQ23(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
              else yyAction53(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction53(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"."
              ...
              then if inp = #"-"
                  then yyQ25(strm', yyMATCH(strm, yyAction53, yyNO_MATCH))
                  else yyAction53(strm, yyNO_MATCH)
            else if inp = #"0"
        ...
        | SOME(inp, strm') =>
            if inp = #"2"
              ...
              then if inp = #"]"
                  ...
                  then if inp = #"\\"
                      then yyQ15(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                      else yyQ9(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                else if inp = #"d"
